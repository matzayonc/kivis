...
//! ## Limitations
//!
//! Known gaps — generic records and key ordering for signed and string keys — are
//! documented in `LIMITATIONS.md` in the repository:
//! <https://github.com/matzayonc/kivis/blob/master/LIMITATIONS.md>
//!
//! ## Quick Start
//!
//! ```rust
